...
export default function FAQPage() {
  ...
  return (
    <div style={{ overflowX: 'hidden' }}>
      ...
      {/* Hero */}
      <section style={{ background: 'linear-gradient(160deg, var(--ivory) 0%, #eef6f3 100%)', padding: '120px 0 70px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
            ...
            <span style={{ fontSize: '11px', fontFamily: 'var(--font-body)', fontWeight: 600, color: '#9c7a3c', letterSpacing: '2.5px', textTransform: 'uppercase' }}>FAQ</span>
          </div>
      ...
      <section style={{ padding: '80px 0 100px', background: 'var(--ivory)' }}>
        <div className="container" style={{ maxWidth: '820px' }}>
          ...
          <div style={{ marginTop: '64px', textAlign: 'center', padding: '48px 40px', background: 'var(--navy-800)', borderRadius: '4px', position: 'relative', overflow: 'hidden' }}>
            ...
            <Link to="/contact" className="cta-blink" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '13px 32px', background: 'var(--gold)', color: 'var(--navy-800)', borderRadius: '2px', fontSize: '12px', fontWeight: 600, fontFamily: 'var(--font-body)', textDecoration: 'none', letterSpacing: '1px', textTransform: 'uppercase' }}>
              Book a Consultation →
            </Link>
          </div>
        </div>
