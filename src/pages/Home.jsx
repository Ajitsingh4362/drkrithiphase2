          ...
          <div style={{
            ...
            <div className="hero-visual-wrapper">
              ...
              <div style={{ textAlign: 'center', marginTop: '16px' }}>
                ...
                {/* Social links */}
                <div style={{ fontSize: '11px', fontWeight: 600, color: '#9c7a3c', letterSpacing: '1.5px', textTransform: 'uppercase', marginTop: '18px', marginBottom: '10px' }}>
