    ...
    <div ref={ref} style={{ overflowX: 'hidden' }}>
      ...
      <section style={{ background: 'linear-gradient(160deg, var(--ivory) 0%, #eef6f3 100%)', padding: '140px 0 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: '17px', color: 'var(--text-muted)', maxWidth: '620px', lineHeight: '1.9', fontWeight: 400, fontFamily: 'var(--font-body)', marginBottom: '16px' }}>
          ...
          <p style={{ fontSize: '17px', color: 'var(--text-light)', maxWidth: '620px', lineHeight: '1.9', fontWeight: 400, fontFamily: 'var(--font-body)', marginBottom: '16px' }}>
          ...
          <p style={{ fontSize: '17px', color: 'var(--text-light)', maxWidth: '620px', lineHeight: '1.9', fontWeight: 400, fontFamily: 'var(--font-body)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2px' }}>
            {SPECS.filter(s => !s.highlight).map((s, i) => (
              <div key={i} style={{ background: 'var(--white)', padding: '36px 32px', borderBottom: '3px solid transparent', transition: 'var(--transition)' }}
                ...
                <p style={{ fontSize: '17px', color: 'var(--text-muted)', lineHeight: '1.8', marginBottom: '20px' }}>{s.desc}</p>
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {s.points.map((p, j) => (
                    <li key={j} style={{ display: 'flex', gap: '8px', fontSize: '13px', color: 'var(--text-muted)' }}>
      ...
      <section style={{ padding: '80px 0', background: 'var(--ivory)' }}>
        <div className="container" style={{ maxWidth: '720px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '17px', color: 'var(--text-muted)', lineHeight: '1.9', fontFamily: 'var(--font-body)', fontWeight: 400, marginBottom: '12px' }}>
          ...
          <p style={{ fontSize: '17px', color: 'var(--text-muted)', lineHeight: '1.9', fontFamily: 'var(--font-body)', fontWeight: 400 }}>
      ...
      <section style={{ background: 'var(--gold)', padding: '70px 0', textAlign: 'center' }}>
        <div className="container">
          ...
          <Link to="/contact">
            <button className="cta-blink" style={{ background: 'var(--navy-800)', color: 'var(--white)', border: 'none', padding: '14px 32px', borderRadius: '2px', fontSize: '13px', fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', cursor: 'pointer' }}>
              Book Consultation
            </button>
          </Link>
        </div>
