      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '52px' }}>
          <div style={{
            ...
            <span style={{ fontSize: '26px', lineHeight: 1, color: 'var(--teal)' }}>&#10022;</span>
            <h2 style={{
              fontFamily: 'var(--font-display)', fontSize: 'clamp(26px, 3.6vw, 38px)',
              fontWeight: 700, color: 'var(--navy-800)', margin: 0, letterSpacing: '0.5px',
            }}>
              Partnerships
            </h2>
          </div>
          ...
          <div style={{ width: '60px', height: '2px', background: 'var(--teal)', margin: '0 auto 18px' }} />
          <p style={{
        ...
        <div style={{
          ...
          {PARTNERS.map((partner, i) => (
            <div key={i} style={{
              ...
              textAlign: 'center', border: '1px solid rgba(30,111,106,0.12)',
              boxShadow: '0 8px 28px rgba(15,39,68,0.06)',
              display: 'flex', flexDirection: 'column', alignItems: 'center',
              transition: 'transform 0.25s, box-shadow 0.25s',
            }}
              onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 14px 36px rgba(15,39,68,0.10)' }}
              onMouseLeave={e => { e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = '0 8px 28px rgba(15,39,68,0.06)' }}
            >
              <div style={{
                ...
                {partner.logo ? (
                  ...
                  <span style={{ fontFamily: 'var(--font-display)', fontSize: '22px', fontWeight: 700, color: 'var(--teal)' }}>
              ...
              <h4 style={{
                ...
                color: 'var(--navy-800)', marginBottom: '10px',
              }}>
                {partner.name}
              </h4>
              <p style={{ fontSize: '13px', color: 'var(--text-muted)', lineHeight: '1.7', margin: '0 0 20px', flex: 1 }}>
                {partner.description}
              </p>
              <a href={partner.url} target="_blank" rel="noopener noreferrer"
                ...
                onMouseLeave={e => { e.currentTarget.style.color = 'var(--teal)'; e.currentTarget.style.borderColor = 'var(--teal)' }}
              >
                View More →
              </a>
            </div>
